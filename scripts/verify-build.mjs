...
const sitemapUrls = [
  ...
  "https://about.wukai.work/KaiWU_CV_20260826.pdf",
...
if (!existsSync(dist)) {
  ...
  if (!cvPage.includes("KaiWU_CV_20260826.pdf")) fail("cv redirect page does not point to the PDF");
